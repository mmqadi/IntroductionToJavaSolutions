	...
	public static void main(String[] args) {
		...
		if(status == 0) {
			...
			if(income <= 8350)
				...
				tax = 8350 * 0.10 + (33950 - 8350) * 0.10 + (68525 - 33950) * 0.25 + (104425 - 68525) * 0.28 + (186475 - 104425) * 0.33 + (income - 186475) * 0.35;
		}
			...
			if(income <= 11950)
				...
				tax = 11950 * 0.10 + (45500 - 11950) * 0.15 + (income - 44550) * 0.25;
			else if(income <= 190200)
				tax = 11950 * 0.10 + (45500 - 11950) * 0.15 + (117450 - 44550) * 0.25 + (income - 117450) * 0.28;
			else if(income <= 372950)
				tax = 11950 * 0.10 + (45500 - 11950) * 0.15 + (117450 - 44550) * 0.25 + (190200 - 117450) * 0.28 + (income - 190200) * 0.33;
			else
				tax = 11950 * 0.10 + (45500 - 11950) * 0.15 + (117450 - 44550) * 0.25 + (190200 - 117450) * 0.28 + (372950 - 190200) * 0.33 + (income - 372950) + 0.35;
		}
